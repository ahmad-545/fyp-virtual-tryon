...
function Home() {
  const slides = [
    { id: 1, tag: "Premium AI Fitting", title: "The Smart Way\nTo Dress Better", subtitle: "Experience the virtual trial revolution live.", btnText: "Explore Studio", link: "/virtual-room", image: slider2 },
    { id: 2, tag: "Summer Collections 2026", title: "Minimal Design\nMaximum Vibe", subtitle: "Bespoke lightweight wear with up to 50% seasonal discount.", btnText: "Shop Collection", link: "/shop", image: "https://kumo-shreethemes.netlify.app/assets/banner-11-lO2D7fxO.png" },
    { id: 3, tag: "Exclusive Fabrics Line", title: "From Raw Bolt\nTo Finished Masterpiece", subtitle: "Crafted details engineered for absolute comfort.", btnText: "View Products", link: "/shop", image: "https://kumo-shreethemes.netlify.app/assets/banner-7-D32H2fF0.png" },
  ];
