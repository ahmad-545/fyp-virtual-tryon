                ...
                <div className="block relative w-full overflow-hidden bg-gray-100 aspect-[3/4]">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="bg-gray-900 hover:bg-black py-3 px-2 text-[11px] font-bold uppercase tracking-wider text-white flex items-center justify-center gap-1.5 transition-colors"
                    >
