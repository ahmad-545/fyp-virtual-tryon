  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative font-sans antialiased text-gray-800">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        {/* Header Banner - Matched exactly with ListProduct theme */}
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              {orders.map((order) => (
                <div 
                  key={order._id} 
                  className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-0 hover:border-gray-300 transition duration-200"
                >
                  ...
                  <div className="col-span-1 lg:col-span-4 p-6 bg-gray-50/50 lg:border-r border-gray-200 space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] bg-blue-600 text-white px-2.5 py-1 rounded-md font-mono font-bold tracking-wider shadow-sm">
                    ...
                    <div className="space-y-3 text-xs text-gray-600">
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <p className="leading-relaxed text-gray-700">
                          <span className="font-bold text-gray-400 block text-[10px] uppercase tracking-wider">Shipping Address</span>
                    ...
                    {order.billingAddress && (
                      <div className="pt-3.5 border-t border-gray-200/60 text-xs text-gray-600 space-y-1">
                        <span className="font-bold text-blue-600 block text-[10px] uppercase tracking-wider">Billing Address</span>
                  ...
                  <div className="col-span-1 lg:col-span-5 p-6 space-y-3 max-h-[280px] overflow-y-auto custom-scrollbar">
                    <p className="text-[10px] uppercase tracking-wider font-bold text-blue-600 mb-1">Purchased Products ({order.items.length})</p>
